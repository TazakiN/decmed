...
impl RmeSegmentData {
    pub fn new(
        ...
        Ok(Self {
            ...
            correction_of_index: request.correction_of_index,
...
impl ClientEncryptedRmeSegment {
    pub fn validate(&self) -> Result<(), SegmentValidationError> {
        ...
        for (field, value) in [
            ...
            ("hospital_cid", self.hospital_cid.as_str()),
    ...
    pub fn into_metadata(
        ...
        RmeSegmentMetadata {
            ...
            hospital_cid: self.hospital_cid,
...
pub struct RmeSegmentMetadata {
    ...
    pub related_rme_id: String,
    pub patient_address: String,
    #[serde(alias = "hospital_id", alias = "fasyankes_id")]
    pub hospital_cid: String,
    pub dataset_category: DatasetCategory,
    pub function_category: FunctionCategory,
    pub ipfs_cid: String,
